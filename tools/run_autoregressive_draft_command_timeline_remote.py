...
def _build_gpu_sampler_script() -> str:
    return "\n".join((
        "import ctypes,json,multiprocessing,os,signal,sys,time,traceback",
        ...
        "  check(nvml,'nvmlDeviceGetUUID',nvml.nvmlDeviceGetUUID(",
        ...
        "  raise RuntimeError('GPU sampler child closed its pipe') from error",
