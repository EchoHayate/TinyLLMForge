...
CASE_SCHEMA = "exact-greedy-decode-burst.case.v1"
CORRECTNESS_SCHEMA = "exact-greedy-decode-burst.correctness.v1"
SUMMARY_SCHEMA = "exact-greedy-decode-burst.summary.v1"
SOURCE_SCHEMA = "exact-greedy-decode-burst.source.v1"
WORKLOAD_SCHEMA = "exact-greedy-decode-burst.workload.v1"
COMPARISON_SCHEMA = "exact-greedy-decode-burst.comparison.v1"
GATE_SCHEMA = "exact-greedy-decode-burst.gate.v1"
MANIFEST_SCHEMA = "exact-greedy-decode-burst.manifest.v1"
VERIFICATION_SCHEMA = (
...
def _classification(evaluation: dict) -> str:
    ...
    return "GO_EXACT_GREEDY_DECODE_BURST"
