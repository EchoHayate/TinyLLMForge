#!/usr/bin/env python3
"""Source-bound clean-GPU controller for the split-phase K8 gate."""
...
TASK_REMOTE_ROOT = APPROVED_ROOT + "/exact-burst-split-phase"
...
LOCAL_ARTIFACT_ROOT = (
    REPO_ROOT / "artifacts" / "exact_burst_split_phase"
)
...
def run_controller(args) -> dict:
    ...
    preflight = {
        "schema_version": "exact-burst-split-phase.controller.v1",
        "status": "READY",
