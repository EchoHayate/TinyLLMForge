    ...
    *,
    ...
    try:
        while not engine.is_finished():
            ...
            speculative_sequence_ids = observation.get(
            ...
            sequence_ids = (
                tuple(
                    int(sequence_id)
                    for sequence_id in speculative_sequence_ids
                )
                if speculative_sequence_ids
                else tuple(
                    int(sequence_id)
                    for sequence_id, token_ids in observation[
