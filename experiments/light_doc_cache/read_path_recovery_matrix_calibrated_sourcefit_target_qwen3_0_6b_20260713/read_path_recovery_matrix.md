...
- Non-oracle argmax-preserving modes: `repeat_last_target`, `correlated_same_layer_target`, `calibrated_single_pair_target`, `calibrated_multiprompt_same_layer_target`, `calibrated_multiprompt_calfit_target`.
