...
| `calibrated_multiprompt_target` | trained | 9.55884 | 146 | 4.0625 | 0.538956 | True | 785 |
...
- Non-oracle argmax-preserving modes: `repeat_last_target`, `correlated_same_layer_target`, `calibrated_single_pair_target`, `calibrated_multiprompt_target`.
- `correlated_same_layer_target` has the best non-oracle mean logit diff.
- `calibrated_multiprompt_target` has the best non-oracle missing-token MSE.
