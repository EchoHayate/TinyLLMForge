    ...
    result = {
        ...
        "official_vs_engine_rank3": [
            ...
            },
            {
                ...
                **compare(
                    official_rank3["core"],
                    rank3_recompute["core"].unsqueeze(0).float(),
                ),
            },
            {
                "name": "final_state",
        ...
        "schema_version": "qwen35.tp4-cached-decode-step4-layer8-rank3-fixture.v8",
