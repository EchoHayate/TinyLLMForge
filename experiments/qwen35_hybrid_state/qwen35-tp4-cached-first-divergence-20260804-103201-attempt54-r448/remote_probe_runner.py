...
def main():
    ...
    try:
        ...
        official_attention = official_layer20.self_attn
        ...
        def enter_official_layer20_attention(_module, _args):
            official_rotary_scope["active"] = True

        def exit_official_layer20_attention(_module, _args, value):
            official_rotary_scope["active"] = False
            return value
        ...
        hooks.append(
            official_attention.register_forward_pre_hook(
                enter_official_layer20_attention
            )
        )
        hooks.append(
            official_attention.register_forward_hook(
                exit_official_layer20_attention
            )
        )
        hooks.append(
    ...
    try:
        ...
        engine_attention = engine_layer20.full_attention
    ...
    for name in component_names:
        if (
            ...
            raise RuntimeError(
                f"missing layer20 decode component capture: {name}"
            )
    ...
    result = {
        ...
        "schema_version": "qwen35.tp4-cached-request1-step38-layer20-components.v10",
