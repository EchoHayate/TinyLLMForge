...
def main():
    ...
    try:
        ...
        local_query_heads = attention.num_attention_heads // 4
        local_kv_heads = max(1, attention.num_key_value_heads // 4)
