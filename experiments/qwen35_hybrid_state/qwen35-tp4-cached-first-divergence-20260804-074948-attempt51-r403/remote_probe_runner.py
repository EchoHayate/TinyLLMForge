...
def main():
    ...
    try:
        ...
        probe._run_request(
            engine, prompt, 9, timeout_s=configuration.timeout_s
        )
        phase["name"] = None
        probe._run_request(
            engine,
    ...
    fixture = {
        "official_probabilities": (
            official_attention_core["probabilities"].to(torch.bfloat16)
        ),
        "official_repeated_value": (
            official_attention_core["repeated_value"].to(torch.bfloat16)
        ),
        "official_output": (
            official_attention_core["output"].to(torch.bfloat16)
        ),
    ...
    torch.save(fixture, output / "layer7_attention_fixture.pt")
    ...
    result = {
        ...
        "schema_version": "qwen35.tp4-cached-decode-step8-layer7-attention-fixture.v5",
