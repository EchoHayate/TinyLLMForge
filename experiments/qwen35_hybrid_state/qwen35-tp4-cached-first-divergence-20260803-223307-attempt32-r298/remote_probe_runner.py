...
def main():
    ...
    try:
        ...
        official_chunk_rule = official_linear.chunk_gated_delta_rule
        ...
        def official_chunk_for_engine(
            ...
            **_kwargs,
            ...
            output, state = official_chunk_rule(
                query.unsqueeze(0),
                key.unsqueeze(0),
                value.unsqueeze(0),
                g=decay.unsqueeze(0),
            ...
            return (
                output.squeeze(0).to(query.dtype),
                state.squeeze(0)
                .transpose(-1, -2)
        ...
        def wrapped_engine_chunk(*args, **kwargs):
            ...
            return (
                official_chunk_for_engine(*args, **kwargs)
                if is_layer0_prefill
                else original_engine_chunk(*args, **kwargs)
            )
    ...
    result = {
        ...
        "schema_version": "qwen35.tp4-cached-decode-step1-layer0-official-chunk.v1",
