...
def main():
    ...
    rank1_fixture_path = Path('/tmp/qwen35_attempt52_r426_rank1_layer7_step19_core.pt')
    ...
    torch.save(
        {
            "schema_version": (
                "qwen35.layer7-step19-rank1-head2-pv-reduction.v1"
            ),
            "context_length": rank1_fixture["context_length"],
            "head_dim": 256,
            "local_query_heads": 2,
            "global_head": 2,
            "probabilities": rank1_fixture["probabilities"],
            "value": rank1_fixture["value"],
            "expected_output": official_rank1_head2["pre_gate"],
            "engine_output": rank1_fixture["pre_gate"],
        },
        output / "rank1_head2_pv_reduction_fixture.pt",
    )
