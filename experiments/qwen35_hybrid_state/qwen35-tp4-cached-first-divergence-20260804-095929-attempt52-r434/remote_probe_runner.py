...
def main():
    ...
    rank1_fixture_path = Path('/tmp/qwen35_attempt52_r434_full_layer7_step19_core.pt')
    ...
    torch.save(
        {
            "schema_version": (
                "qwen35.layer7-step19-full-pv-reduction.v2"
            ),
        ...
        output / "full_pv_reduction_fixture.pt",
    )
