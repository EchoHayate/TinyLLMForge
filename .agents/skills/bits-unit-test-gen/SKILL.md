...
- [ ] Check for project conventions (`AGENTS.md`, `AGENTS.md`) in project root → read unit-test-relevant parts if found
- [ ] Determine **MODE**:
...
> `AGENT_SOURCE` must be one of: `trae`, `traecli`, `codex`, `Codex`, `aime`, `coze`, `cursor`, `unknown`
