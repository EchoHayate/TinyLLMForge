...
class Qwen35MTPProposalExecutor:
    ...
    def __init__(
        ...
        *,
        ...
        self._proposal_authority_rows: dict[str, dict] = {}
    ...
    def _register_group_proposals(
        ...
        try:
            ...
            for proposal, (
                ...
                self._proposal_authority_rows[transaction_id] = {
                    "sequence_id": input_row.sequence_id,
                    ...
                    "staged_entry_count": int(
                        proposal.metadata["staged_entry_count"]
                    ),
    ...
    def prepare_finalize_batch(
        ...
        for row, transaction_id in zip(rows, transaction_ids):
            authority_row = self._proposal_authority_rows[
                transaction_id
            ]
            ...
            authority_row["finalize_ticket_id"] = batch_ticket_id
    ...
    def tp4_authority_snapshot(self) -> dict:
        cache_snapshot = self.proposal_kv_cache.authority_snapshot()
        return {
            "tensor_parallel_rank": self.tensor_parallel_rank,
            "tensor_parallel_size": self.tensor_parallel_size,
            "proposal_transactions": [
                dict(row)
                for row in self._proposal_authority_rows.values()
            ],
            "selected_tokens": [
                dict(row)
